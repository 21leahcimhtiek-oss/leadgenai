        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-violet-600/10 border border-violet-500 rounded-2xl p-8 text-left relative">
            ...
            <ul className="space-y-3 mb-8 text-sm">
              ...
              <li className="flex items-center gap-2 text-gray-300 text-sm"><span className="text-green-400">+</span>AI lead discovery</li>
              <li className="flex items-center gap-2 text-gray-300 text-sm"><span className="text-green-400">+</span>Lead scoring</li>
              <li className="flex items-center gap-2 text-gray-300 text-sm"><span className="text-green-400">+</span>Contact enrichment</li>
              <li className="flex items-center gap-2 text-gray-300 text-sm"><span className="text-green-400">+</span>LinkedIn integration</li>
              <li className="flex items-center gap-2 text-gray-300 text-sm"><span className="text-green-400">+</span>Email verification</li>
              <li className="flex items-center gap-2 text-gray-300 text-sm"><span className="text-green-400">+</span>CRM sync</li>
              <li className="flex items-center gap-2 text-gray-300 text-sm"><span className="text-green-400">+</span>Pipeline analytics</li>
              <li className="flex items-center gap-2 text-gray-300 text-sm"><span className="text-green-400">+</span>Outreach automation</li>
            </ul>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 text-left">
            ...
            <div className="text-4xl font-bold mb-1">$319</div>
